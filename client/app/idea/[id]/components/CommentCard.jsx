            ...
            <div className="rounded-xl border p-5  shadow-md w-full bg-white">
                <div className="flex w-full items-center justify-between border-b pb-3">
                    <div className="flex items-center space-x-3">
                        ...
                        <div className="text-lg font-normal text-slate-700">Joe Smith</div>
                    </div>
                    ...
                    <div className="flex items-center justify-between text-slate-500">
                        <div className="flex space-x-4 md:space-x-8">
                            <div className="flex cursor-pointer items-center transition hover:text-slate-600 gap-2">
                                <Link className="cursor-pointer flex gap-2 items-center justify-between w-full px-4 py-2 text-center text-white duration-200 bg-black border-2 border-black rounded-full nline-flex hover:bg-transparent hover:border-black hover:text-black focus:outline-none lg:w-auto focus-visible:outline-black text-sm focus-visible:ring-black"
                                      href="/feed/newpost">
                    ...
                    <div className="bg-white pl-2 mt-4  w-full">
                        ...
                        <div>
                            <Comment
                                ...
                                username="John Doe"
                                content="This is the first comment. Lorem ipsum dolor sit amet, consectetur adipiscing elit."
                            />
                            <Comment
                                avatarUrl="https://images.unsplash.com/photo-1527980965255-d3b416303d12?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1180&q=80"
                                username="Jane Smith"
                                content="The second comment here. Duis aliquam ligula in nisl egestas sollicitudin."
                            />
                        </div>
